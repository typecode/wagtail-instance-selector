...
install_requires = ["django==3.2.13","wagtail>=2.15"]
...
setup(
    ...
    long_description="Documentation at https://github.com/typecode/wagtail-instance-selector",
    author="The Interaction Consortium",
    author_email="admins@interaction.net.au",
    url="https://github.com/typecode/wagtail-instance-selector",
